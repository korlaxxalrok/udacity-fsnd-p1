...
# Favorite movie #5
flash_gordon = media.Movie('Flash Gordon', '''GORDON'S ALIVE!''',
'https://upload.wikimedia.org/wikipedia/en/5/50/Flash_gordon_movie_poster.jpg',
'https://www.youtube.com/watch?v=OROLRvKamdE')

# Favorite movie #6
the_fifth_element = media.Movie('The Fifth Element', '''Me fifth element -
