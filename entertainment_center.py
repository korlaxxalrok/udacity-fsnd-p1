...
blade_runner = media.Movie('Blade Runner',
                           'I want more life, fucker.', 'https://upload.wikimedia.org/wikipedia/en/5/53/Blade_Runner_poster.jpg',
...
# Favorite movie #3
mad_max_beyond_thunderdome = media.Movie('Mad Max: Beyond Thunderdome'
